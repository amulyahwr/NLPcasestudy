...
def evaluate_dataset(split_name, dataset_cls, model, embedding, loader, batch_size, device, is_multilabel):
    ...
    print('Evaluation metrics for', split_name, flush=True)
    print(metric_names, flush=True)
...
if __name__ == '__main__':
    ...
    if torch.cuda.is_available() and args.cuda:
        print('Note: You are using GPU for training', flush=True)
    ...
    print('No. of target classes:', train_iter.dataset.NUM_CLASSES, flush=True)
    print('No. of train instances', len(train_iter.dataset), flush=True)
    print('No. of dev instances', len(dev_iter.dataset), flush=True)
    print('No. of test instances', len(test_iter.dataset), flush=True)
